...
class Classifier:
    ...
    def __init__(self, weights: Union[str, Path] = "yolo26n-cls.pt"):
    ...
    def export(self, format: str = "onnx", img_size: int = 640) -> Path:
        return Path(self._model.export(format=format, imgsz=img_size))
